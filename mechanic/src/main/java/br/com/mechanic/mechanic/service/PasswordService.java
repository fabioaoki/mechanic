...
public class PasswordService implements PasswordServiceBO {
    ...
    @Override
    public void save(Long providerAccountId, String password, String login) {
        log.info("Service: valid password");
        validPassword(password);
        log.info("Service: Saving a password");
        ProviderPassword providerPassword = PasswordMapper.MAPPER.toEntity(providerAccountId, password, login);
