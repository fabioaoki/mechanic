...
public enum ErrorCode {
    ...
    ERROR_VEHICLE_TYPE, ERROR_EQUIPMENT_NOT_FOUND, ERROR_CREATED_EMPLOYEE, ERROR_CREATED_COLOR, ERROR_COLOR_NOT_FOUND, ERROR_CLIENT_ACCOUNT_NOT_FOUND, ERROR_OPDATE_CLIENT, ERROR_CLIENT_ADDRESS_NOT_FOUND;
}
